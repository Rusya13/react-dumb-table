...
class SimpleDataTable extends React.Component {
    ...
    _renderHeader( columns , headerHeight) {
        return (
            <thead>
            <tr >
                {columns.map( ( col, index ) => {
                    return (
                        <th style={{height:headerHeight}}  className="flex-wrap" key={index}>
                            <div className="data-table__header-box">{col.title}</div>
    ...
    _renderLimitSelector(limit, limitsList){
        return (
            <div className="data-table__footer-limit-selector-wrapper">
                ...
                <svg viewBox="0 0 24 24" width="24" height="24"><path d="M7 10l5 5 5-5z"></path></svg>
            </div>
        )
    }
            ...
            <div id="table" ref={( ref ) => this.tableWrapper = ref} className="data-table">
                <div
                    ...
                    <table ref={( ref ) => this.table = ref}>
                        ...
                        {this._renderHeader( columns, headerHeight )}
                    </table>
                </div>
