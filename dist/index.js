...
var DumbTable = exports.DumbTable = function (_React$Component) {
  ...
  function DumbTable(props) {
    ...
    _this._setColumnsSize = function (columns) {
      columns.reduce(function (secondIndex, column, index) {
        _this.cols[index].style.width = column.width + '%';
        _this.cols[secondIndex].style.width = column.width + '%';
  ...
  (0, _createClass3.default)(DumbTable, [{
          ...
          columns.map(function (col, index) {
            return _react2.default.createElement(
              'th',
              {
                ...
                onContextMenu: _this2._contextHeaderHandler.bind(_this2, col, index, col.key),
                'data-index': index,
                key: index
              },
              _react2.default.createElement(
                'div',
                {
                  onClick: _this2._orderChangeHandler.bind(_this2, orderBy, col.sortKey || col.key, orderDirection),
    ...
    value: function _renderRow(row, index, columns) {
      ...
      return columns.map(function (column, cellIndex) {
        ...
        var value = _this3._get(row, column.key);
        if (value === undefined) {
          if ((typeof row === 'undefined' ? 'undefined' : (0, _typeof3.default)(row)) === 'object') {
            if (row.get && typeof row.get === 'function') {
              ...
              if (object.length > 1) {
                ...
                value = _this3._get(row.get(object[0]), str);
              } else {
                value = row.get(object[0]);
              }
            }
          } else {
            value = _this3.props.defaultCellValue;
          }
        }
        ...
        return _react2.default.createElement(
          'td',
          {
            ...
            onClick: _this3._onCellClickHandler.bind(_this3, row, index, column),
            onContextMenu: _this3._contextHandler.bind(_this3, row, index, column.key),
            key: cellIndex
          },
          value
        );
      ...
      return _react2.default.createElement(
        ...
        data.map(function (row, index) {
          ...
          return _react2.default.createElement(
            ...
            _this4._renderRow(row, index, columns)
          );
        })
      );
    }
    ...
    value: function _renderSelectItems(items) {
      ...
      return items.map(function (item, index) {
        return _react2.default.createElement(
          'div',
          {
            onMouseDown: _this5._onLimitChangeHandler.bind(_this5, item),
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          ref: function ref(limitSelect) {
            return _this6.limitSelect = limitSelect;
          }
        },
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          footerHeight = _props.footerHeight,
          total = _props.total,
          limit = _props.limit,
          offset = _props.offset,
          limitsList = _props.limitsList,
          headerHeight = _props.headerHeight,
          selectedRowIndexes = _props.selectedRowIndexes,
